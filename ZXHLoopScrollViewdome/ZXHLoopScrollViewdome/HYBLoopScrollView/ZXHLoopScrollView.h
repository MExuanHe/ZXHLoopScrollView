 ...
 */
typedef NS_ENUM(NSInteger, ZXHPageControlAlignment) {
  /**
 ...
 */
typedef void (^ZXHLoopScrollViewDidSelectItemBlock)(NSInteger atIndex);
 ...
 */
typedef void (^ZXHLoopScrollViewDidScrollBlock)(NSInteger toIndex);

typedef NS_ENUM(NSUInteger, ZXHFlowLayoutType) {
  kZXHFlowLayoutTypeDefault,
  kZXHFlowLayoutTypeScaleHorizontal
};
 ...
 */
@interface ZXHLoopScrollView : UIView
 ...
 */
@property (nonatomic, strong, readonly) ZXHPageControl *pageControl;
 ...
 */
@property (nonatomic, assign) ZXHPageControlAlignment alignment;
 ...
 *
 *  @return The ZXHLoopScrollView object.
 */
